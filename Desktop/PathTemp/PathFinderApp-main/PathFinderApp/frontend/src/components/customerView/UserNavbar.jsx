...
import { FaBars, FaTimes, FaUser, FaGraduationCap } from "react-icons/fa";
...
const UserNavbar = () => {
  ...
  // Emoji nav items
  const navItems = [
    { path: "/userHome", label: "HOME", emoji: "🏠" },
    { path: "/skillform", label: "SKILL FORM", emoji: "🤖" },
    { path: "/expertProfiles", label: "EXPERT PROFILE", emoji: "📘" },
    { path: "/studentMeetingRequest", label: "MEETINGS", emoji: "📅" },
        ...
        <div className="flex justify-between items-center h-16">
          ...
          >
            <div className="bg-gradient-to-r from-[#2DE2E6] to-[#FF6EC7] p-2 rounded-xl mr-3 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-[#2DE2E6]/20">
              <FaGraduationCap className="text-[#1D1E2C] text-xl" />
            </div>
            <div className="flex flex-col">
              <span className="text-lg font-bold bg-gradient-to-r from-[#2DE2E6] to-[#FF6EC7] bg-clip-text text-transparent">
                PathFinder
              </span>
              <span className="text-xs text-[#2DE2E6] font-medium bg-[#2DE2E6]/10 px-2 py-0.5 rounded-full">
                User Portal
              </span>
            </div>
          </NavLink>
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            <div className="flex items-center space-x-2">
              <div className="flex items-center bg-[#2a2b3d] px-3 py-2 rounded-xl">
                <div className="w-2 h-2 bg-[#2DE2E6] rounded-full mr-2 animate-pulse"></div>
                <span className="text-xs text-[#2DE2E6] font-medium">USER</span>
              </div>

              <NavLink
                to="/logout"
                className="bg-gradient-to-r from-[#2DE2E6] to-[#FF6EC7] text-[#1D1E2C] px-5 py-3 rounded-xl hover:shadow-lg hover:shadow-[#2DE2E6]/30 transition-all duration-300 flex items-center group font-semibold"
              >
                <span aria-hidden="true" className="mr-2">
                  🔐
                </span>
          ...
          <div className="flex lg:hidden items-center space-x-2">
            <div className="hidden sm:flex items-center bg-[#2a2b3d] px-2 py-1 rounded-lg">
              <div className="w-1.5 h-1.5 bg-[#2DE2E6] rounded-full mr-1 animate-pulse"></div>
              <span className="text-xs text-[#2DE2E6] font-medium">USER</span>
            </div>
        ...
        <div className="lg:hidden bg-[#1D1E2C]/95 backdrop-blur-xl px-4 pt-2 pb-6 space-y-2 animate-slide-down">
          ...
          <div className="flex items-center justify-center py-3 mb-2">
            <div className="flex items-center bg-[#2a2b3d] px-4 py-2 rounded-xl">
              <div className="w-2 h-2 bg-[#2DE2E6] rounded-full mr-2 animate-pulse"></div>
              <span className="text-sm text-[#2DE2E6] font-medium">
                User Mode
              </span>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-[#2DE2E6]/20 mt-2">
            <NavLink
              to="/logout"
              className="flex items-center justify-center py-4 px-4 bg-gradient-to-r from-[#2DE2E6] to-[#FF6EC7] text-[#1D1E2C] text-center rounded-xl hover:shadow-lg hover:shadow-[#2DE2E6]/30 transition-all duration-300 font-semibold"
              onClick={() => setMenuOpen(false)}
            >
              <span aria-hidden="true" className="mr-2">
                🔐
